                      ...
                      <div class="box-body">
                         <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <label for="exampleInputEmail1"> Choose image 1 </label>
                              ...
                              <div class="form-group">
                                <img src="{{url($edit->image2.'') }}" height="60" width="70"><br>
                                <label for="exampleInputEmail1"> Choose image 2 </label>
                                <input type="hidden"  name="url2" value="{{$edit->image2 }}">
                               <input type="file" name="image2"  class="form-control" id="exampleInputEmail1" placeholder="Enter ">
                           </div>
                           <div class="form-group">
                            <img src="{{url($edit->background.'') }}" height="60" width="70"><br>
                            <label for="exampleInputEmail1"> Choose background </label>
                            <input type="hidden"  name="background" value="{{$edit->background }}">
                           <input type="file" name="background"  class="form-control" id="exampleInputEmail1" placeholder="Enter ">
                       </div>
