...
{    
    ...
    public function home()
    {
      ...
      $contact = DB::table('contactus')->whereNull('deleted_at')->limit(1)->first();
      //dd($contact);
      $services = DB::table('services')->whereNull('deleted_at')->get();
      

      $Testimonil=Testimonil::all();
      $features=Features::whereNull('deleted_at')->get();
      // $menu_service = DB::table('services')->whereNull('deleted_at')->limit(12)->get();
      
      $clients = DB::table('clients')->whereNull('deleted_at')->take(5)->get();
      $sliders = DB::table('slider')->whereNull('deleted_at')->get();
      $description = DB::table('aboutus')->whereNull('deleted_at')->limit(1)->first();
      $offers_menu = DB::table('offers')->get();
      $menu_ourwork = DB::table('ourwork')->get();
      $projects=Work::with('ourwork')->get();
      $teams = DB::table('team')->get();

      return view('frontend.home.index',compact('teams','projects','sliders','features','Testimonil','offers_menu','contact','menu_ourwork','services','clients','description'));
    }
